  ...
  return (
    <section ref={container} className="relative h-screen w-full flex flex-col items-center justify-center bg-[#050505] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center translate-y-12">
        ...
        <h1 className={`flex flex-col items-start ${inspirationFont.className}`}>
          <span className="reveal-text text-8xl md:text-[10rem] text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)] font-normal p-4 mb-2 opacity-0 block">
            Antoine
          </span>
          <span className="reveal-text text-8xl md:text-[10rem] text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)] font-normal p-4 pr-12 ml-8 md:ml-24 opacity-0 block">
            Bayart
          </span>
        </h1>
